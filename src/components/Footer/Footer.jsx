        ...
        <div>
            ...
            <div className="container mx-auto grid grid-cols-1 justify-items-center md:grid-cols-3 gap-8 place-items-start">
                    ...
                    <div>
                        ...
                        <p className="mb-2">Sadar Rd, Barguna 8700,Bangladesh</p>
                        <p className="mb-2">Phone: 01737-782265</p>
                        <p>Email: sahareiors@gmail.com</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="https://facebook.com" className="hover:text-blue-800">
                                <svg  className="fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg>
                            </a>
